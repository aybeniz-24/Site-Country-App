...
function menu(){
    ...
    function big() {
        ...
        bigcard.innerHTML = `
            ...
            <div id="metn">
                ...
                <p>${item.region}</p>
                <p>${item.id}</p>
                <p>Area: ${item.area} km<sup>2</sup></p>
    ...
    function toggleDarkMode() {
        ...
        cards.forEach(card => {
            if (isDarkMode) {
                card.style.backgroundColor = '#718096'
            } else {
                card.style.backgroundColor = '#718096';
            }
        });
    ...
    function toggleDarkMode() {
        ...
        spans.forEach(span => {
            if (isDarkMode) {
                span.style.backgroundColor = '#718096'; 
            } else {
                span.style.backgroundColor = '#718096';
            }
        });
    ...
    function show(start, end) {
        data.slice(start, end).forEach((item) => {
            container.innerHTML += `
                <div onclick="mainCard('${item.id}')" class="cards" style="">
                    <img src="${item.flag}" alt="img" />
...
function search() {
    const query = document.getElementById("inp").value.toLowerCase();
    ...
    if (query === "") {
        ...
        function selectBorder(elementId) {
            if (secilmeyen) {
                secilmeyen.style.borderColor = 'transparent';
            }
        
            const selectedElement = document.querySelector(`#${elementId}`);
            selectedElement.style.borderColor = '#8b5cf6';
